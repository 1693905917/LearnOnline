...
public class WxAuthServiceImpl implements AuthService, WxAuthService {
    ...
    public XcUser addWxUser(Map userInfo_map){
        ...
        xcUser.setStatus("1");//用户状态：1代表可用状态
    ...
    /**获取用户信息，示例如下：
     ...
     "city":"CITY",
     "country":"COUNTRY",
     "headimgurl": //头像"https://thirdwx.qlogo.cn/mmopen/g3MonUZtNHkdmzicIlibx6iaFqAc56vxLSUfpb6n5WKSYVY0ChQKkiaJSgQ1dZuTOgvLLrhJbERQQ4eMsv84eavHiaiceqxibJxCfHe/0",
     "privilege":[
     "PRIVILEGE1",
     "PRIVILEGE2"
     ],
    ...
    private Map<String,String> getUserinfo(String access_token,String openid) {
        ...
        //防止名称乱码进行转码，因为微信的编码是ISO_8859_1，我们要转成UTF_8
