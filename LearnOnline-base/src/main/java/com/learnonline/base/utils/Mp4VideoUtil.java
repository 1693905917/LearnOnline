package com.learnonline.base.utils;
...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String video_path = "E:\\Java\\IDEA_Practice\\xueCheng-plus\\develop\\upload\\Day7.avi";
    String mp4_name = "Day7_a.mp4";
    String mp4folder_path = "E:/Java/IDEA_Practice/xueCheng-plus/develop/upload/";
...
//        ProcessBuilder builder = new ProcessBuilder();
//        builder.command("D:\\BaiduNetdiskDownload\\QQ\\Bin\\QQScLauncher.exe");
////将标准输入流和错误输入流合并，通过标准输入流程读取信息
//        builder.redirectErrorStream(true);
//        Process p = builder.start();
        ...
        String mp4_name = "Day7_a.mp4";
        //转换后mp4文件的路径
        String mp4_path = "E:\\Java\\IDEA_Practice\\xueCheng-plus\\develop\\upload\\Day7_a.mp4";
        //创建工具类对象
