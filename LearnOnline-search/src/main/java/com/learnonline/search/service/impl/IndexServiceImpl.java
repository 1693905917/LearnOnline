package com.learnonline.search.service.impl;

import com.alibaba.fastjson.JSON;
import com.learnonline.base.execption.LearnOnlineException;
import com.learnonline.search.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
 ...
 public Boolean addCourseIndex(String indexName,String id,Object object) {
  ...
  try {
   ...
   e.printStackTrace();
   LearnOnlineException.cast("添加索引出错");
  }
 ...
 public Boolean updateCourseIndex(String indexName,String id,Object object) {
  ...
  try {
   ...
   e.printStackTrace();
   LearnOnlineException.cast("更新索引出错");
  }
 ...
 public Boolean deleteCourseIndex(String indexName,String id) {
  ...
  try {
   ...
   e.printStackTrace();
   LearnOnlineException.cast("删除索引出错");
  }
  //获取响应结果
